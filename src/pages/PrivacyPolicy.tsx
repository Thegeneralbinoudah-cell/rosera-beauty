    ...
    <div className="min-h-dvh bg-background px-4 py-8 pb-28">
      <div className="mx-auto max-w-lg">
        ...
        <div className="mt-8 space-y-8 text-foreground leading-relaxed">
          ...
          <section>
            <h2 className="border-s-4 border-accent ps-3 text-lg font-semibold text-foreground">استخدام البيانات</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="border-s-4 border-accent ps-3 text-lg font-semibold text-foreground">مشاركة البيانات</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="border-s-4 border-accent ps-3 text-lg font-semibold text-foreground">تخزين البيانات</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="border-s-4 border-accent ps-3 text-lg font-semibold text-foreground">حقوق المستخدم</h2>
            <p className="mt-2">
